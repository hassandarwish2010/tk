...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
        ...
        <li><a href="{{ route('agents.index') }}">{{ __('lang.agents') }}</a></li>
  ...
  <div class="col-sm-12">
      <div class="white-box">
        <div class="row adminform">
          ...
          <form class="form-full-width" action="{{ route('agents.update', $agent->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
