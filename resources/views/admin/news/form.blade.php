      ...
      <div class="white-box">
          <div class="row">
              <div class="col-sm-12 col-xs-12">
                ...
                <textarea id="editor2" name="ar_details" rows="8" class="form-control" style="resize:vertical;width:100%;" placeholder="{{ __('lang.ar_details') }}">discription discription discription discription discription</textarea>
